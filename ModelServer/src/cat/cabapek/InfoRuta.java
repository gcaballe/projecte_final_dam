...
public class InfoRuta {
    ...
    public InfoRuta(int id, String titol, String descMarkDown, int desnivell, int alçadaMax, int alcadaMin, float distanciaKm, int tempsAprox, boolean circular, int dificultat, String gpxURL, String photoURL, String photoTitol, Categoria categoria) {
        this.id = id;
        this.titol = titol;
    ...
    public String toString() {
        return "InfoRuta{" + "id=" + id + ", titol=" + titol + ", descMarkDown=" +
                descMarkDown.substring(0,15) + "..." + ", desnivell=" + desnivell + ", al\u00e7adaMax=" + 
                alçadaMax + ", alcadaMin=" + alcadaMin + ", distanciaKm=" + distanciaKm + ", tempsAprox=" + 
                tempsAprox + ", circular=" + circular + ", dificultat=" + dificultat + ", gpxURL=" + 
                gpxURL + ", photoURL=" + photoURL + ", photoTitol=" + photoTitol + 
                ", categoria=" + categoria+ '}';
    }
