...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-05-2020 a las 19:17:04
...
(2, 'segon punt de la 1a ruta', 'blablablablalbal', 32, 17.130000, 13.160000, 1100, 'https://upload.wikimedia.org/wikipedia/commons/5/56/Atuel_River.JPG', 1);
...
(2, 'Segona ruta', '<h1>Descirpcio en HTML</h1>\r\n<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>', 400, 1000, 500, 20, 300, 0, 2, NULL, 'https://upload.wikimedia.org/wikipedia/commons/5/56/Atuel_River.JPG', 3);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `taula_autoincrement`
--

CREATE TABLE `taula_autoincrement` (
  `nom_taula` varchar(128) COLLATE utf8_spanish_ci NOT NULL,
  `valor` bigint(8) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `taula_autoincrement`
--
...
--
-- Indices de la tabla `taula_autoincrement`
--
ALTER TABLE `taula_autoincrement`
  ADD PRIMARY KEY (`nom_taula`);
